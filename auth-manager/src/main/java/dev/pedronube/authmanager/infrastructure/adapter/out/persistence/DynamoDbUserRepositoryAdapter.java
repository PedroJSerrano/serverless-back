package dev.pedronube.authmanager.infrastructure.adapter.out.persistence;

import lombok.RequiredArgsConstructor;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import dev.pedronube.authmanager.domain.port.out.UserRepositoryPort; // La interfaz funcional
import dev.pedronube.authmanager.domain.model.User;
import dev.pedronube.authmanager.infrastructure.adapter.out.persistence.entity.UserDynamoEntity;
