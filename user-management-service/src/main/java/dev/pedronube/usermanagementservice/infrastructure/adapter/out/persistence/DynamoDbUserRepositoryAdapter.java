package dev.pedronube.usermanagementservice.infrastructure.adapter.out.persistence;

import lombok.RequiredArgsConstructor;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import dev.pedronube.usermanagementservice.domain.model.User;
import dev.pedronube.usermanagementservice.domain.port.out.CreateUserRepositoryPort;
import dev.pedronube.usermanagementservice.domain.port.out.DeleteUserRepositoryPort;
import dev.pedronube.usermanagementservice.domain.port.out.UpdateUserRepositoryPort;
import dev.pedronube.usermanagementservice.infrastructure.adapter.out.persistence.model.UserDynamoEntity;
